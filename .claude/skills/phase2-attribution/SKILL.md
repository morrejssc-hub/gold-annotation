...
description: 为《狼与香辛料》语料做 Phase 2 说话人归属(uid→speaker 序列标注)。当用户要"跑 Phase 2""做归属/标说话人""给某章/全部章节标 speaker""phase2 提取"时使用。用 Claude subagent 并行扇出,每个 subagent 读整章+cast 产出 phase2/<篇名>.json。
---
