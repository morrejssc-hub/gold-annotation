...
- [`.Codex/skills/cast-sheet/SKILL.md`](.Codex/skills/cast-sheet/SKILL.md) — Codex 跑 Phase 1 的 subagent 扇出流程。
...
python3 src/phase1_cast.py jsons/后日谈.json --backend dump   # Phase 1 提示词；--backend Codex|bailian|codex 调 API
...
- `src/` — 全部 `.py` 脚本。**从仓库根运行**（如 `python3 src/dialogue.py jsons/…`）：数据与产物目录留在根。
